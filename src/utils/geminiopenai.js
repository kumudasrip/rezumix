...
export async function GeminiOpenAI(resumeText) {
    try {
        const system_prompt = `
        You are a professional resume analyzer and ehnacer. 
        your task is to analyze user's resume and  based on the given conditions
        
        Analyze and improve the following resume by identifying strengths, weaknesses, and areas for improvement, while also making necessary corrections to enhance clarity, readability, and ATS optimization. The response includes structured feedback and a corrected resume version with improvements applied.  
        ...
        provide ats score to user.
        also provide a brief summary of the resume and provide recommendations for improvement.
        ...
        Enhance Section Headings: Use industry-standard formats such as:  
